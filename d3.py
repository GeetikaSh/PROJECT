...
<style>
body {
background-image: url("https://www.fool.com/investing/2021/01/09/3-stocks-that-are-absurdly-cheap-right-now/");
...
# Now let's plot the total volume of stock being traded each day
  ...
  a little deeper. We're now going to analyze the risk of the stock. In order to 
